...
st.set_page_config(
    page_title="Automatic Deviation Calculation Dashboard PT. KPP",
    layout="wide",
    ...
    if logo_base64_final:
        ...
        <div class="header-container">
            ...
            <div class="title-wrapper">
                <h1 class="main-title">Automatic Deviation Calculation Dashboard</h1>
...
# SIDEBAR
    with st.sidebar:
        ...
        <div style='text-align:center;color:#9ca3af;margin-top:2rem'>
            <p style='color:#ffffff;font-weight:700;font-size:0.95rem'>Automatic Deviation Calculation Dashboard</p>
...
<div class="rf">PT Kalimantan Prima Persada — Automatic Deviation Calculation Dashboard System<br>Report generated: {report_date} · </div>
</div>
</body></html>"""
